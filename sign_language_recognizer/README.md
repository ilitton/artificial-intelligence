...
### Repo Structure: 
* [`asl_recognizer.ipynb`](asl_recognizer.ipynb): solution and walkthrough 
* [`my_model_selectors.py`](my_model_selectors.py): model implementations (constant selector, CV, BIC, DIC)
* [`my_recognizer.py`](my_recognizer.py): function to recognize test word sequences from word models set
...
1. Recommended install: [Anaconda](https://www.continuum.io/downloads), a pre-packaged Python distribution that contains all of the necessary libraries and software for this project.
