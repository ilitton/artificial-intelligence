...
class SelectorBIC(ModelSelector):
    ...
    def score(self, n_components):
        ...
        n_params = n_components * (n_components - 1) + 2 \
                        * n_features * n_components + n_components - 1
        score = -2.0 * logL + n_params * np.log(n_features) 
...
class SelectorDIC(ModelSelector):
    ...
    Biem, Alain. "A model selection criterion for classification: Application hmm topology optimization."
...
class SelectorCV(ModelSelector):
    ...
    def score(self, n_components):
        ...
        for train_index, test_index in split_method.split(self.sequences):
            ...
            model = self.base_model(n_components)
            X, l = combine_sequences(test_index, self.sequences)
