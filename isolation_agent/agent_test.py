...
class CounterBoard(isolation.Board):
    ...
    def copy(self):
        ...
        new_board.__active_player__ = self._active_player
        new_board.__inactive_player__ = self._inactive_player
        new_board.__board_state__ = deepcopy(self._board_state)
